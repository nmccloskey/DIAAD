...
In both the CLI and webapp versions, DIAAD function *3a* matches original with reliability transcripts based on common tiers plus a `reliability` tag in the file name, e.g., `TU88_PreTxBrokenWindow.cha` & `TU88PreTxBrokenWindow_reliability.cha`.  
...
*CLI*
 ...
 - Succinct: `diaad 3a`
 - Expanded: `diaad "transcripts evaluate"`
