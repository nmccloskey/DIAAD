...
- Succinct: `diaad 4a`
- Expanded: `diaad "transcripts make"`
...
- Optional: Fill *speaking_time* (seconds) in the *samples* sheet if you intend to include speaking rate later (e.g., target vocabulary coverage).
