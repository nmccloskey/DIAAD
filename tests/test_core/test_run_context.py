...
class FakeConfigManager:
    def __init__(self, config_dir, config_overrides=None):
        ...
        self.powers_coding_filename = "powers_coding.xlsx"
        ...
        self.utterance_id_field = self.utterance_id_column
        ...
        self.advanced = SimpleNamespace(
            ...
            cu_samples_filename="cu_samples.xlsx",
            speaking_time_filename="speaking_times.xlsx",
            speaking_time_column="speaking_time",
            word_count_filename="word_counts.xlsx",
            word_count_column="word_count",
            wc_samples_filename="wc_samples.xlsx",
